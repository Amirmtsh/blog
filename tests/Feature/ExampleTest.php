...
class ExampleTest extends TestCase
{
    ...
    public function test_example()
    {
        ...
        // $tag1 = $post->tags()->create(['tagname' => 'tagname1']);
        // $tag2 = $post->tags()->create(['tagname' => 'tagname2']);
        // $tag3 = $post->tags()->create(['tagname' => 'tagname3']);
        ...
        // $response = $this->post("/posts/{$post->id}/tags", ["tagname" => "tagname"]);
